namespace Ringify.Web.Infrastructure
{
    ...
    public class RoleInWrongPortException : Exception
    {
        public RoleInWrongPortException()
            : base("The Web Role is running in a wrong port. Please review the troubleshooting section of the Windows Azure Toolkit for WP7 for guidance in this issue.")
        {
        }
