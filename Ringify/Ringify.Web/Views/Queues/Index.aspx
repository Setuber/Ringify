...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Manage Queue Permissions</asp:Content>
        ...
        <% 
            ...
            foreach (var item in this.Model)
            {
                ...
                <div class="storage-heading">
                    ...
                    <p class="storage-title">Queue: <span><%: item.StorageItemName %></span></p>
                </div>                    
...
//<![CDATA[
    var publicActionUrl = "<%= this.Url.Action("SetQueuePublic", new { queue = "_storage_", isPublic = "_isPublic_" }) %>";
    var addQueuePermissionActionUrl = "<%= this.Url.Action("AddQueuePermission", new { queue = "_storage_", userId = "_user_" }) %>";
    var removeQueuePermissionActionUrl = "<%= this.Url.Action("RemoveQueuePermission", new { queue = "_storage_", userId = "_user_" }) %>";
//]]>
</script>
</asp:Content>