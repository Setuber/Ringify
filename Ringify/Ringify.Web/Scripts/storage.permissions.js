    ...
    $.ajax({
        ...
        success: function (data) {
            if (typeof data == "string") {
                var msg = "<img src=\"/Content/error_small.png\" alt=\"An error has ocurred while sending the push notification.\" title=\"An error has ocurred while sending the push notification.\" />";
                msg += " " + data;
                ...
                $.each(data, function (i, e) {
                    if (e.Status != "Success") {
                        msg += "<img src=\"/Content/error_small.png\" alt=\"An error has ocurred while sending the push notification.\" title=\"An error has ocurred while sending the push notification.\" />"
                        msg += " Device " + (i + 1) + " / " + data.length + " failed: " + e.Description + "<br />";
                    } else {
                        msg += "<img src=\"/Content/success_small.png\" alt=\"Notification successfully sent.\" title=\"Notification successfully sent.\" />"
